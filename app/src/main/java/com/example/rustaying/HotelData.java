...
public class HotelData extends AppCompatActivity {
    ...
    private void showData(DataSnapshot dataSnapshot){
        ...
        Log.d(TAG, "Array 1: " + ratingOneData);
        Log.d(TAG, "Array 2: " + ratingTwoData);
        Log.d(TAG, "Array 3: " + ratingThreeData);
        Log.d(TAG, "Array 4: " + ratingFourData);
        Log.d(TAG, "Array 5: " + ratingFiveData);
        ...
        Log.d(TAG, "Average 1: " + ratingOneAvg);
        Log.d(TAG, "Average 2: " + ratingTwoAvg);
        Log.d(TAG, "Average 3: " + ratingThreeAvg);
        Log.d(TAG, "Average 4: " + ratingFourAvg);
        Log.d(TAG, "Average 5: " + ratingFiveAvg);
