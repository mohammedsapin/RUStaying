...
public class ViewGuests extends AppCompatActivity {
    ...
    private void showData(DataSnapshot dataSnapshot) {
        for (DataSnapshot data : dataSnapshot.getChildren()){
            ...
            Guest info = new Guest(); // create new object

            info.setFirstName(data.getValue(Guest.class).getFirstName()); // set first name
            info.setLastName(data.getValue(Guest.class).getLastName()); // set last name
            info.setGuestEmail(data.getValue(Guest.class).getGuestEmail()); // set email
