...
public class RoomServicesAdapter extends RecyclerView.Adapter<RoomServicesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i){
        ...
        viewHolder.statusR.setText(info.getStatus());
        viewHolder.idR.setText(String.valueOf(info.getId()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        CardView card;
        TextView requestType, requestDate, requestTime,  checkbox, input, idR, statusR;

        public ViewHolder(@NonNull View itemView){
            super(itemView);
            card = itemView.findViewById(R.id.RoomServicesCard);
