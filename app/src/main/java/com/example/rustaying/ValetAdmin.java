...
public class ValetAdmin extends AppCompatActivity {

    private static final String TAG = "ValetAdmin";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valet_admin);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null){
                    startActivity(new Intent(ValetAdmin.this, LoginActivity.class ));
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ValetAdmin.this);
                alertDialog.setMessage("Do you want to logout?")
                        //Positive button is Yes, meaning the use wants to logout
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(ValetAdmin.this,"Logged out",Toast.LENGTH_SHORT).show();
                                mAuth.signOut();
                            }
                        })
